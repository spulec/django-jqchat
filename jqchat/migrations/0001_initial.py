...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'jqchat', ['Room'])

        # Adding model 'Message'
        db.create_table(u'jqchat_message', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'jqchat', ['Message'])

        # Adding model 'RoomMember'
        db.create_table(u'jqchat_roommember', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jqchat.Room'], null=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'jqchat', ['RoomMember'])


    def backwards(self, orm):
        # Deleting model 'Room'
        db.delete_table(u'jqchat_room')

        # Deleting model 'Message'
        db.delete_table(u'jqchat_message')

        # Deleting model 'RoomMember'
        db.delete_table(u'jqchat_roommember')
    ...
    models = {
        ...
        u'jqchat.message': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'room': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['jqchat.Room']"}),
            'text': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'unix_timestamp': ('django.db.models.fields.FloatField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'jchat_messages'", 'to': u"orm['auth.User']"})
        },
        u'jqchat.room': {
        ...
        u'jqchat.roommember': {
            'Meta': {'ordering': "['user']", 'object_name': 'RoomMember'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'room': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['jqchat.Room']", 'null': 'True'}),
